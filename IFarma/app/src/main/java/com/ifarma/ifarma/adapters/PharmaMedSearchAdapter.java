...
import com.ifarma.ifarma.holders.PharmaMedHolder;
...
public class PharmaMedSearchAdapter extends RecyclerView.Adapter<PharmaMedHolder> implements Filterable {
    ...
    private PharmaMedHolder holder;

    public PharmaMedSearchAdapter(Context context, ArrayList<Product> mProductArrayList) {
    ...
    @Override
    public PharmaMedHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        view =  LayoutInflater.from(parent.getContext())
                .inflate(R.layout.pharma_meds_list_view, parent, false);
        holder = new PharmaMedHolder(view);

        return holder;
    }

    @Override
    public void onBindViewHolder(PharmaMedHolder holder, int position) {
